...
const MandiriForm = ({ onSubmit, initialData = {} }) => {
  ...
  const inputClass = "w-full px-4 py-2.5 bg-slate-950 border-2 border-slate-800 focus:border-yellow-500 rounded-xl focus:ring-2 focus:ring-yellow-900/30 transition-all duration-200 text-sm text-slate-100 placeholder-slate-600 outline-none";
  const selectClass = "w-full px-4 py-2.5 bg-slate-950 border-2 border-slate-800 focus:border-yellow-500 rounded-xl focus:ring-2 focus:ring-yellow-900/30 transition-all duration-200 text-sm text-slate-100 outline-none";
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
      ...
      <div className="flex items-center gap-4 mb-6 pb-5 border-b border-slate-800">
        <div className="w-12 h-12 bg-yellow-500 rounded-xl flex items-center justify-center text-slate-950 font-black text-xs tracking-wider shadow-lg shadow-yellow-500/20">
          MDR
        </div>
        <div>
          <h2 className="text-xl font-bold text-white tracking-wide">Bank Mandiri Terminal</h2>
      ...
      <button
        type="submit"
        className="w-full py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-755 text-slate-950 rounded-2xl font-black text-sm tracking-widest shadow-lg shadow-yellow-500/20 hover:shadow-yellow-500/35 transition-all duration-300 transform active:scale-[0.98] uppercase"
      >
        ⚡ Generate Mandiri SWIFT MT103 Document
      </button>
    </form>
  );
};
