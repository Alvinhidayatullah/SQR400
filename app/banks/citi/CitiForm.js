...
const CitiForm = ({ onSubmit, initialData = {} }) => {
  ...
  const inputClass = "w-full px-4 py-2.5 bg-slate-950 border-2 border-slate-800 focus:border-blue-500 rounded-xl focus:ring-2 focus:ring-blue-900/30 transition-all duration-200 text-sm text-slate-100 placeholder-slate-600 outline-none";
  const selectClass = "w-full px-4 py-2.5 bg-slate-950 border-2 border-slate-800 focus:border-blue-500 rounded-xl focus:ring-2 focus:ring-blue-900/30 transition-all duration-200 text-sm text-slate-100 outline-none";
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
      ...
      <div className="flex items-center gap-4 mb-6 pb-5 border-b border-slate-800">
        <div className="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center text-white font-black text-xs tracking-wider shadow-lg shadow-blue-500/20">
          CITI
        </div>
        <div>
          <h2 className="text-xl font-bold text-white tracking-wide">CitiBank Terminal</h2>
      ...
      <button
        type="submit"
        className="w-full py-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-2xl font-black text-sm tracking-widest shadow-lg shadow-blue-500/20 hover:shadow-blue-500/35 transition-all duration-300 transform active:scale-[0.98] uppercase"
      >
        ⚡ Generate CitiBank SWIFT MT103 Document
      </button>
    </form>
  );
};
